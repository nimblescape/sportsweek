...
- While an item is dragged, the position it would take is shown, and the item itself follows the pointer, drawn over the rest and faded, so what is being moved is what the user is looking at.
