...
- After the attendance category the row carries two more the assignment dialog has no use for, in this order. Equipment rental (see US-11) offers both answers as tags, "Ausrüstung zum Leihen" and "Keine Ausrüstung zum Leihen"; a student whose program asks for no equipment was never put the question and is left out of both. Health offers a single tag, "Krankheit oder Medikamente", which gathers the students who wrote something in the health notes field or answered that they carry medication (see US-11) — a teacher looks for the students to be aware of, and everybody else is simply the rest. Both tags name what they gather rather than the category they sit under, since the row carries no headings.
