...
- The figures are shown as cards stacked one above the other, in the order of the list they belong to. Each card carries a collapsible triangle in front of its title, pointing right while the card is folded and down while it is open, and every card folds on its own.
