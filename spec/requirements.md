...
- Beside the tags, a Save button lets the teacher save the report as it currently stands under a name, entered inline without leaving the report page. The tag it creates is the marked one from that moment, and whichever tag was marked before is released with it: the report on screen and the tag that says so stay the same thing.
