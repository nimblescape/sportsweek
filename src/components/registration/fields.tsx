...
import { YES_NO_LABELS } from "@/lib/registration/answer-labels";
import {
  Select,
  SelectContent,
  SelectItem,
...
/**
 * A value the student is shown but does not own — the event series they are registering for and the
