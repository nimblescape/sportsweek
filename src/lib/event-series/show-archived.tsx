...
/**
 * Whether the event series list is showing archived event series.
 *
 * It lives above both pages rather than in the list, because stepping into an event series' events and
 * coming back is one errand: a teacher who revealed the archive to reach an old event series should not
 * have to reveal it again on the way back. Mounted on the event series segment, which is the narrowest
